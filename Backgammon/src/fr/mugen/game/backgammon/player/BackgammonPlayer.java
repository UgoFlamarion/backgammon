...
public abstract class BackgammonPlayer extends Player {
  ...
  public void play(final Board board, final Rules rules, final Display display) {
    // System.out.println("WHITE DEADS = " + ((BackgammonBoard)
    // board).getColumn(BackgammonBoard.WHITE_CEMETERY_POSITION).getNumber());
    // System.out.println("BLACK DEADS = " + ((BackgammonBoard)
    // board).getColumn(BackgammonBoard.BLACK_CEMETERY_POSITION).getNumber());
